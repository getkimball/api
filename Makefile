...
DEPS = ranch cowboy jsx prometheus prometheus_cowboy hackney trails cowboy_swagger swaggerl kuberlnetes eraven etbloom kube_dist
...
dep_kube_dist = git https://github.com/getkimball/kube_dist.git 0.0.2
